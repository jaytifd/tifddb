...
#################POSTCARD REPORT ################
        ...
        if request.GET.get('table'):
            ...
            return report_by_slug_render(request, report_by_slug,fields,result_dict,thisyear, extra=addresses, template='registrar/reports_postcards_addresslabels.html')
