...
class PaymentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "housing_fee": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "late_fee": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "other_fee": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "bobbi_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "chuck_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "floor_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "general_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "music_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "t_shirt_fee": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "camp_fund": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "gfc_linens": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
            "paypal_fee_reimburse_fee": NumberInput(
                attrs={"style": "width: 5em;", "step": "any", "placeholder": "0.00"}
            ),
        }
...
MembershipPersonFormset = modelformset_factory(
    MembershipPerson,
    fields=[
        "first_name",
        "last_name",
...
MembershipPersonFormset_inline = inlineformset_factory(
    CampRegistration,
    MembershipPerson,
    form=MembershipPersonForm,
    extra=0,
