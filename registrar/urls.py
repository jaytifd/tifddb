...
urlpatterns = [
    ...
    path(
        ...
        views.payments_delete,
        name="payments_delete",
    ),
    path(
        "payments/edit/<int:payment_id>", views.payments_add, name="payments_add_edit"
    ),
    path(
        "payments/quick/<int:registration_id>",
        views.payments_quick,
        name="payments_quick",
    ),
    ...
    path(
        "registrar/update/<int:registration_id>",
        views.registrar_update,
    ...
    path(
        "donationletter/<int:registration_id>",
        views.donationletter_endpoint,
        name="donationletter",
    ),
