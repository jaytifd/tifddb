...
from django.forms import modelformset_factory, DateInput, NumberInput
from django import forms
from camp.custom.mylogger import p
from camp.models import CampRegistration, CampRegistrationTypes, CampCamper_adult
...
RegistrationFormset_edit = modelformset_factory(
    ...
    widgets={
        ...
        "donation_floor_fund": NumberInput(
            attrs={
                "style": "width: 7em;",
                "step": "any",
                "placeholder": "0.00",
        ...
        "donation_camp_fund": NumberInput(
            attrs={
                "style": "width: 7em;",
                "step": "any",
                "placeholder": "0.00",
        ...
        "donation_live_music": NumberInput(
            attrs={
                "style": "width: 7em;",
                "step": "any",
                "placeholder": "0.00",
        ...
        "donation_bobbi_gillotti": NumberInput(
            attrs={
                "style": "width: 7em;",
                "step": "any",
                "placeholder": "0.00",
...
class PersonForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["registration_type"].queryset = (
            CampRegistrationTypes.objects.filter(active=True).filter(
