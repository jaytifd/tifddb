...
RegistrationFormset_edit = modelformset_factory(
    CampRegistration,
...
RegistrationFormset_new = modelformset_factory(
    CampRegistration,
    fields=regform_fields,
    form=RegistrationForm,
    # exclude=['transaction_id','session','paymenttype','registration_status','registrar_approval_note','adjustment'],
...
class RegistrationForm_adult(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["certification"].widget.attrs[
            "class"
        ...
        self.fields["need_linen"].widget.attrs[
            "class"
        ] = "checkboxinput form-check-input"
        self.fields["free_t_shirt"].widget.attrs[
            "class"
        ] = "checkboxinput form-check-input"
        self.fields["dvd"].widget.attrs["class"] = "checkboxinput form-check-input"
        self.fields["dvd"].label = (
            self.fields["dvd"].label + " ($" + str(CampPrices.get_price("dvd")) + ")"
        )
        self.fields["join_tifd"].widget.attrs[
            "class"
        ] = "checkboxinput form-check-input"
...
class RegistrationForm_child(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["band"].widget.attrs["class"] = "checkboxinput form-check-input"
        self.fields["singing"].widget.attrs["class"] = "checkboxinput form-check-input"
        self.fields["family_program"].widget.attrs[
            "class"
        ] = "checkboxinput form-check-input"
        self.fields["need_linen"].widget.attrs[
            "class"
...
class RebateForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["rebate"].queryset = CampRebates.objects.all().exclude(
            slug="legacy"
        )
...
class CamperNotesForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["camper_note"].label = (
            "Notes, questions, or comments for the registrar:"
        )
...
class SafetypolicyForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["agreecheckbox"].label = (
...
RegistrationFormset_adult = inlineformset_factory(
    CampRegistration,
    CampCamper_adult,
    form=RegistrationForm_adult,
    extra=4,
    widgets={
        "diet_details": Textarea(
            attrs={
                "cols": 40,
                "rows": 1,
            }
...
RegistrationFormset_child = inlineformset_factory(
    CampRegistration,
    CampCamper_child,
