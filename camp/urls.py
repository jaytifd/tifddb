...
urlpatterns = [
    ...
    path(
        "delete/camper/<int:registration_id>", views.deletecamper, name="deletecamper"
    ),
    path(
        "delete/registration/<int:registration_id>",
        views.delete_entire_registration,
        name="delete_entire_registration",
    ),
    ...
    path(
        "checkpayment/<int:registration_id>", views.checkpayment, name="check_payment"
    ),
    path(
        "paypalpayment/<int:registration_id>",
        views.paypalpayment,
        name="paypal_payment",
    ),
    path(
        "paypalreturn/<int:registration_id>", views.paypalreturn, name="paypal_return"
    ),
