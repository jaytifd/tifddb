...
class CampRegistration(models.Model):
    ...
    donation_tifd = models.DecimalField("TIFD fund donation", max_digits=7, validators=[MinValueValidator(Decimal('0.00'))], decimal_places=2, blank=True, null=True, default=0.0)
    donation_chuck = models.DecimalField("Donation in remembrance of Chuck Roth", max_digits=7, validators=[MinValueValidator(Decimal('0.00'))], decimal_places=2, blank=True, null=True, default=0.0)
...
class Person(models.Model):
    ...
    singing = models.BooleanField("I am interested in attending singing classes.", blank=True, null=False, default=False)
